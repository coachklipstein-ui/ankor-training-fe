...
export type RpcBulkCreateEvaluationsResponse =
  { ok: true; count: number; data: EvaluationRecord[] } | { ok: false; error: string };
...
export type ListEvaluationsHttpPayload =
  { data: EvaluationListItem[] | null; error: string | null } | EvaluationListItem[];
...
export type LatestEvaluationsResponse =
  { ok: true; count: number; data: LatestEvaluationRow[] } | { ok: false; error: string };
...
export type EvaluationImprovementSkillsResponse =
  { ok: true; count: number; data: EvaluationImprovementSkillRow[] } | { ok: false; error: string };
...
export type EvaluationSkillVideosResponse =
  { ok: true; count: number; data: EvaluationSkillVideoRow[] } | { ok: false; error: string };
...
export type EvaluationWorkoutProgressResponse =
  { ok: true; count: number; data: EvaluationWorkoutProgressRow[] } | { ok: false; error: string };

export type EvaluationWorkoutProgressUpdateResponse =
  { ok: true; data: EvaluationWorkoutProgressRow } | { ok: false; error: string };
...
export type EvaluationWorkoutDrillsResponse =
  { ok: true; count: number; data: EvaluationWorkoutDrillLevel[] } | { ok: false; error: string };
...
export type EvaluationMatrixOperation =
  EvaluationMatrixUpsertRatingOp | EvaluationMatrixRemoveAthleteOp;
