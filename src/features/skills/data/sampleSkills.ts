...
export const SAMPLE_SKILLS: Skill[] = [
  ...
  },
  {
    ...
    category: 'Shooting',
    title: 'Speed',
    description: 'Generate power through efficient body mechanics and release tempo.',
    level: 'all',
  ...
  },
  {
    ...
    category: 'Stickwork',
    title: 'Quick Release',
    description: 'Deliver quick, clean exchanges to maintain tempo and spacing in tight areas.',
    level: 'all',
    coaching_points: null,
    visibility: 'org',
    status: 'approved',
